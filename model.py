...
class Discriminator(nn.Module):
    ...
    def forward(self, x):
        ...
        downsample1 = self.droupout(downsample1)

        downsample2 = self.downSample2(downsample1)

        downsample3 = self.downSample3(downsample2)
        downsample3 = self.droupout(downsample3)
...
"""
this code copy from https://huggingface.co/audeering/wav2vec2-large-robust-12-ft-emotion-msp-dim
"""
